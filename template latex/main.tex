...
% Capa
\newgeometry{margin=0em,top=14em}
    \vspace{5cm}
...
\begin{tikzpicture}[thick,scale=0.05,every node/.style={scale=1.6},overlay]
    \node[anchor=north west,inner sep=0pt] at ($(current page.south west)+(103cm,-230cm)$) {
